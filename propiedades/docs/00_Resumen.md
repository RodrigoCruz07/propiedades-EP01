# Propiedades — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Propiedades del caso caso11 (InmoNube).

## Contexto

- **Caso**: caso11 — InmoNube (Plataforma inmobiliaria)
