# Propiedades — Despliegue y operación
...
| API base | `/api/propiedads` |

## Docker

```bash
docker build -t duoc/jv0101-caso11-propiedades:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso11-propiedades:1.0.0
```
